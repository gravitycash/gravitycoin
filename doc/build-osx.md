...
Bitcoin Core is now available at `./src/gravitycoind`
...
-------
    ...
    ./src/gravitycoind -daemon # Starts the bitcoin daemon.
...
4. Enter "gravitycoin-qt" as project name, enter src/qt as location
...
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/realspencerdupre/gravitycoin/issues/7714)
