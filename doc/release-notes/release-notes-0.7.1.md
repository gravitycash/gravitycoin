...
source-only tarballs/zipballs directly from there:
  https://github.com/realspencerdupre/gravitycoin/tarball/v0.7.1  # .tar.gz
  https://github.com/realspencerdupre/gravitycoin/zipball/v0.7.1  # .zip
...
/Applications/Bitcoin-Qt (on Mac) or gravitycoind/gravitycoin-qt (on Linux).
...
* When running -testnet, use RPC port 14461 by default.
