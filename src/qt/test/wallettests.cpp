...
//
//     src/qt/test/test_gravitycoin-qt -platform xcb      # Linux
//     src/qt/test/test_gravitycoin-qt -platform windows  # Windows
//     src/qt/test/test_gravitycoin-qt -platform cocoa    # macOS
void TestSendCoins()
{
