...
# TestNode: A peer we use to send messages to gravitycoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes gravitycoind to (reasonably!) disconnect us, so do this last.
    ...
    # gravitycoind's choice of nonce.
    ...
    # Test that gravitycoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for gravitycoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # gravitycoind will not send blocktxn responses for blocks whose height is
