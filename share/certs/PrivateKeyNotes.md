...
allowing somebody to distribute a Bitcoin-Qt.app or gravitycoin-qt-setup.exe with a valid
...
that the gravitycoin-qt.exe file inside the installer had not been tampered with.
