...
{
    BOOST_CHECK(TestSplitHost("www.gravitycoin.org", "www.gravitycoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.gravitycoin.org]", "www.gravitycoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.gravitycoin.org:80", "www.gravitycoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.gravitycoin.org]:80", "www.gravitycoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4460", "127.0.0.1", 4460));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4460", "127.0.0.1", 4460));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4460", "::ffff:127.0.0.1", 4460));
    BOOST_CHECK(TestSplitHost("[::]:4460", "::", 4460));
    BOOST_CHECK(TestSplitHost("::4460", "::4460", -1));
    BOOST_CHECK(TestSplitHost(":4460", "", 4460));
    BOOST_CHECK(TestSplitHost("[]:4460", "", 4460));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4460", "127.0.0.1:4460"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4460", "[::]:4460"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
